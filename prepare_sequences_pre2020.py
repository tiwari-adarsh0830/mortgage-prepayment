"""
prepare_sequences_pre2020.py
-----------------------------
Builds padded sequences using ONLY 2018Q1–2019Q4 vintages (8 vintages).
Purpose: out-of-sample validation — train hazard model on pre-2020 data,
then forecast 2020-21 CPR without the model ever having seen those loans.

Output saved to: data/sequences_pre2020/
Does NOT overwrite data/sequences/ (21-vintage full model).
"""
import pandas as pd
import numpy as np
