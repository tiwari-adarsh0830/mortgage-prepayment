...
Implements the rolling real-time OOS design (Gupta, June 20): train through Dec Y,
forecast Jan–Dec Y+1, roll forward. Directly addresses the equity×rate-incentive
interaction Gupta flagged (high-leverage post-GFC loans did not refinance; low-leverage
2020–21 loans did).
